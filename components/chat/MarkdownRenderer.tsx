 ...
 * blocks. Safe for streaming — react-markdown gracefully handles incomplete
 * syntax (unclosed code fences, unfinished lists, etc.) by rendering whatever
 * tokens it can parse from the current text.
 */
      ...
      <ReactMarkdown
        ...
        components={{
          ...
          code: ({ className: cls, children, ...props }) => {
            const isInline = !cls?.includes("hljs");
            if (isInline) {
              return (
                <code
