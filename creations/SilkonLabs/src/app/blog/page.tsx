...
import { posts, allTags, getPostsByType, type Post } from '@/data/posts';
...
export default function BlogPage() {
  ...
  const blogPosts = useMemo(() => getPostsByType('blog'), []);
        ...
        <div className="container">
          <div className="flex flex-col gap-6">
            ...
            <p className="max-w-2xl text-body-lg text-ink-muted">
              Updates, insights, and behind-the-scenes from the Silkon Labs team.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
                  ...
                  <Card variant="interactive" padding="lg" className="flex flex-col h-full">
                    <div className="flex flex-col gap-4 flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        {post.featured && <Badge variant="copper" size="sm">Featured</Badge>}
                      </div>
                      ...
                      <div className="flex flex-wrap gap-2 mt-auto pt-4 border-t border-hairline">
                        ...
                        {post.tags.length > 3 && (
                          <Badge variant="default" size="sm">+{post.tags.length - 3} more</Badge>
                        )}
                      </div>
                    </div>
          ...
          {totalPages > 1 && (
            <div className="flex justify-center gap-2 mt-10">
              ...
              <span className="flex items-center px-4 text-body-sm text-ink-muted">
          ...
          {filteredPosts.length === 0 && (
            <Card variant="default" padding="xl" className="text-center mt-8">
              <p className="text-body text-ink-muted">No posts match your filters.</p>
