...
export const RESEARCH_SECTION = `\n## Research and sources — grounded answers\n\nWhen a request needs current or verifiable information, use the available search/fetch tools rather than guessing. Treat each retrieved URL as evidence, not proof of every claim. In the final answer:\n- Include a concise **Sources** section with Markdown links using the retrieved source title and URL.\n- Distinguish retrieved facts from your own inference or calculation.\n- Mark inaccessible, failed, stale, or weakly supported sources clearly; never present them as verified.\n- Prefer multiple independent sources for important claims and mention disagreement when sources conflict.\n- Do not invent citations or claim that a source supports content you did not retrieve.\n`;
...
` + MEDIA_SECTION + TOOL_ROLE_GUIDANCE;
