...
const patchSchema = z.object({
  ...
  providerId: z.coerce.number().int().positive().nullable().optional(), modelId: z.string().max(300).nullable().optional(),
  allowedToolNames: z.array(z.string()).optional(), allowedToolGroups: z.array(z.string()).optional(), allowedMcpServerIds: z.array(z.coerce.number().int().positive()).optional(),
